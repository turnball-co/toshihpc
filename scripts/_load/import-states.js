...
const firebaseConfig = {
  apiKey: 'AIzaSyASH8mNg7H-sa2Klf32nOnEzJd7Icyidt4',
  authDomain: 'turnball.co',
  projectId: 'toshihpc',
  storageBucket: 'toshihpc.appspot.com',
  messagingSenderId: '406613248758',
  appId: 'toshihpc'
}

// Initialize Firebase
const app = initializeApp(firebaseConfig)
const db = getFirestore(app, { projectId: 'toshihpc' })
...
const states = [
  ...
  { state_name: 'Northern Mariana Islands', state_code: 'MP' },
  ...
  { state_name: 'Trust Territories', state_code: 'TT' },
...
// Function to insert states into Firestore
const insertStates = async () => {
  const statesCollection = collection(db, 'state_codes')
