...
const countries = [
  ...
  { country_name: 'Bahamas (the)', country_code: 'BS' },
  ...
  { country_name: 'British Indian Ocean Territory (the)', country_code: 'IO' },
  ...
  { country_name: 'Cayman Islands (the)', country_code: 'KY' },
  { country_name: 'Central African Republic (the)', country_code: 'CF' },
  ...
  { country_name: 'Cocos (Keeling) Islands (the)', country_code: 'CC' },
  { country_name: 'Colombia', country_code: 'CO' },
  { country_name: 'Comoros (the)', country_code: 'KM' },
  {
    country_name: 'Congo (the Democratic Republic of the)',
    country_code: 'CD'
  },
  { country_name: 'Congo (the)', country_code: 'CG' },
  { country_name: 'Cook Islands (the)', country_code: 'CK' },
  ...
  { country_name: 'Dominican Republic (the)', country_code: 'DO' },
  ...
  { country_name: 'Falkland Islands (the) [Malvinas]', country_code: 'FK' },
  { country_name: 'Faroe Islands (the)', country_code: 'FO' },
  ...
  { country_name: 'French Southern Territories (the)', country_code: 'TF' },
  { country_name: 'Gabon', country_code: 'GA' },
  { country_name: 'Gambia (the)', country_code: 'GM' },
  ...
  { country_name: 'Holy See (the)', country_code: 'VA' },
  ...
  { country_name: 'Korea (the Republic of)', country_code: 'KR' },
  ...
  { country_name: 'Marshall Islands (the)', country_code: 'MH' },
  ...
  { country_name: 'Moldova (the Republic of)', country_code: 'MD' },
  ...
  { country_name: 'Philippines (the)', country_code: 'PH' },
  ...
  { country_name: 'Republic of North Macedonia', country_code: 'MK' },
  { country_name: 'Romania', country_code: 'RO' },
  { country_name: 'Russian Federation (the)', country_code: 'RU' },
  ...
  { country_name: 'Sudan (the)', country_code: 'SD' },
  ...
  { country_name: 'Turks and Caicos Islands (the)', country_code: 'TC' },
  { country_name: 'Tuvalu', country_code: 'TV' },
  { country_name: 'Uganda', country_code: 'UG' },
  { country_name: 'Ukraine', country_code: 'UA' },
  { country_name: 'United Arab Emirates (the)', country_code: 'AE' },
  {
  ...
  { country_name: 'United States of America (the)', country_code: 'US' },
...
// Function to insert countries into Firestore
const insertCountries = async () => {
  const countriesCollection = collection(db, 'country_codes')

  for (const country of countries) {
    try {
      const docRef = await addDoc(countriesCollection, country)
